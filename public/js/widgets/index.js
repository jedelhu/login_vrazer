$(function()
{
	...
	$('.swal-btn-success').click(function(e){
		...
		$('.cancel').click(function(e){
			window.location.replace("http://loginportal.vrazer.net/admin/connection");
		});
	});
		...
		$.ajax(
				{
					...
					success: function(data)
					{
						...
						$.each(data.list, function(i, element) {
							...
							ctreeHtml += '<i class="jstree-icon jstree-themeicon fa fa-arrow-right jstree-themeicon-custom filee"></i>' + element;
							ctreeHtml += '</li>';
